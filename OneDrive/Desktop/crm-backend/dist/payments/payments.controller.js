...
let PaymentsController = class PaymentsController {
    ...
    async create(dto, user) {
        ...
        return (0, api_response_interface_1.createApiResponse)('To\'lov qabul qilindi', data, 201);
    }
    async findAll(query) {
    ...
    async getStatistics(month) {
        ...
        return (0, api_response_interface_1.createApiResponse)('To\'lov statistikasi', data);
    }
    async findOne(id) {
        const data = await this.paymentsService.findOne(id);
        return (0, api_response_interface_1.createApiResponse)('To\'lov topildi', data);
    }
    async update(id, dto) {
        const data = await this.paymentsService.update(id, dto);
        return (0, api_response_interface_1.createApiResponse)('To\'lov yangilandi', data);
    }
    async remove(id) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.ADMIN, role_enum_1.Role.CASHIER),
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.ADMIN, role_enum_1.Role.CASHIER),
    (0, swagger_1.ApiOperation)({ summary: 'Barcha to\'lovlar' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [payment_dto_1.PaymentQueryDto]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('statistics'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.ADMIN),
    (0, swagger_1.ApiOperation)({ summary: 'To\'lov statistikasi' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(role_enum_1.Role.SUPER_ADMIN, role_enum_1.Role.ADMIN, role_enum_1.Role.CASHIER),
    (0, swagger_1.ApiOperation)({ summary: 'To\'lovni ID bo\'yicha olish' }),
